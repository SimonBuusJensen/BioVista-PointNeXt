...
if __name__ == "__main__":
    ...
    argparse.add_argument("--model_weights", type=str, help="Path to the model weights file.",
                          default="/workspace/datasets/high_and_low_HNV-forest-proxy-train-val-dataset/experiments/3D-PointVector-S/2024-10-22-08-31-38_BioVista-3D-ALS_pointvector-s_batch-sz_8_8192_lr_1e-05_qb-radius_0.7/checkpoint/2024-10-22-08-31-38_BioVista-3D-ALS_pointvector-s_batch-sz_8_8192_lr_1e-05_qb-radius_0.7_E14.pth")

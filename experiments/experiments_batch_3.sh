...
python train_classifier.py --num_points 16384 --qb_radius 0.15 --batch_size_train 16 --cfg cfgs/biovista/pointvector-s.yaml --dataset_csv /home/create.aau.dk/fd78da/datasets/BioVista/datasets/100_high_and_100_low_HNV-forest-proxy-samples/100_high_and_100_low_HNV-forest-proxy-samples_30_m_circles_dataset.csv
